...
class ActivityDashboard:
    ...
    def __init__(self):
        ...
        self.data_path = "../data/activity_by_dpt"
        self.activity_code_path = '../data/naf_2008.json'
    ...
    def merge_datasets(self):
        ...
        for dpt, file_path in self.file_path_list.items():
            ...
            df = self.get_top_categories(
                pd.DataFrame(annotated_rows, 
                            columns = [
                                'dpt', 'activitePrincipaleUniteLegale', 'count']
                            )
        ...
        self.df.columns = ['Departement', 'Activité', 'Total']
